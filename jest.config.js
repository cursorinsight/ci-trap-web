...
module.exports = {
  ...
  // results. Jest will fail if there is less than 80% branch, line, and
  // function coverage, or if there are more than 10 uncovered statements.
  coverageThreshold: {
    'global': {
      'branches': 80,
      'functions': 80,
