;(function (global) { function moduleDefinition(RouteRecognizer, FakeXMLHttpRequest) {

// ---------------------------------------------------------------------------

if ((typeof(RouteRecognizer) === "object") && ('default' in RouteRecognizer)){
...
// ---------------------------------------------------------------------------
  ...
  // node export
  module.exports = moduleDefinition(require('route-recognizer'), require('fake-xml-http-request'));
} else if (typeof define === 'function' && define.amd) {
  // amd anonymous module registration
  define(['route-recognizer', 'fake-xml-http-request'], moduleDefinition);
} else {
  // browser global
  global.xxx = moduleDefinition(global.RouteRecognizer, global.FakeXMLHttpRequest);
}}(this));
