/*! ci-trap v0.1.0 - MIT license */
/* global module require window */

/*
 * Motion event (mouse movement) catcher for browsers emitting data compatible
 * with CI's motion analyzer engine. (touch, gyro, etc. is WIP)
 *
 * Copyright (c) 2012--2014, GOLDA Bence <gbence@ci.hu>
...
(function (global) {
  function moduleDefinition (/*wheelShim*/) { // dependency1, dependency2...
    'use strict'
  // ---------------------------------------------------------------------------
    ...
    function CITrap (element, idleTimeout) {
      ...
      var touchSupport = 'ontouchstart' in windowAlias || // works on most browsers
      ...
      var MouseButtonHandler = require('./mouseButtonHandler.js')
      var PageScrollHandler = require('./pageScrollHandler.js')
      ...
      if (windowSupport) {
        ...
        var WindowPositionHandler = require('./windowPositionHandler.js')
        var WindowUnloadHandler = require('./windowUnloadHandler.js')
        var VisibilityChangeHandler = require('./visibilityChangeHandler.js')
